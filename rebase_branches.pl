...
say "\nNot koha-plugin-edifact-midwest-library-services, exiting" && exit 0 unless $repo eq "koha-plugin-edifact-midwest-library-services";
...
foreach my $repo (@repos) {
    next if $repo eq 'koha-plugin-edifact-midwest-library-services';
    next if $repo eq 'koha-plugin-edifact-midwest-library-services-docs';
