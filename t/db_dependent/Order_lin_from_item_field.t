...
use Koha::Database;
use Koha::Items;
use Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices;
use Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices::Edifact::Order
        ->new(
        {
